...
public class ControladorNavigationUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_usuarios_post, R.id.nav_logros, R.id.nav_cuenta, R.id.nav_temas, R.id.nav_ubicaciones, R.id.nav_configuracion,R.id.nav_chat).setOpenableLayout(drawer).build();
