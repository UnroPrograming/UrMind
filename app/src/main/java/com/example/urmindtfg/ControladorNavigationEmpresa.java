...
import com.example.urmindtfg.databinding.ActivityMainEmpresarioBinding;
...
public class ControladorNavigationEmpresa extends AppCompatActivity {

    private AppBarConfiguration mAppBarConfiguration;
    private ActivityMainEmpresarioBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainEmpresarioBinding.inflate(getLayoutInflater());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_home, R.id.nav_cuenta, R.id.nav_ubicaciones,R.id.nav_chat, R.id.nav_configuracion).setOpenableLayout(drawer).build();
    ...
    private void setDatosUsuarios(){
        ...
        img_perfil.setImageBitmap(Img.getImgBitmap(usuario.getImagen()));
    }
}